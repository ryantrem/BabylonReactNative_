...
namespace Babylon
{
    ...
    void Reset(ANativeWindow* windowPtr)
    {
        if (g_env)
        {
            auto width = static_cast<size_t>(ANativeWindow_getWidth(windowPtr));
...
extern "C" JNIEXPORT void JNICALL Java_com_reactlibrary_BabylonNativeInterop_initEngine(JNIEnv* env, jclass obj, jlong jsContextRef, jobject surface)
{
...
extern "C" JNIEXPORT void JNICALL Java_com_reactlibrary_BabylonNativeInterop_resetEngine(JNIEnv* env, jclass obj, jobject surface)
{
    ANativeWindow* windowPtr = ANativeWindow_fromSurface(env, surface);
    Babylon::Reset(windowPtr);
}
